...
**Loss Ratio Prediction for Auto Insurance** · Python · Pandas · Docker · GCP · Scikit-Learn

Developed a machine learning project to predict loss ratios for insurance policy portfolios using the CRISP-DM methodology, from data preparation and feature engineering through regression model evaluation.

**Bank Marketing Analysis** · Python · Pandas · Scikit-Learn

Performed data preprocessing and analysis, evaluated fairness metrics to identify potential bias in datasets.

**Housing Price Prediction App** · Python · Docker · GCP

Built and trained a machine learning model and deployed the application to Cloud Run using automated CI/CD pipelines. [GitHub](https://github.com/anirudhsshirahati/housing-price-prediction-app)
...
[Recommendations](/recommendations) · [Contact Me](/contact)
